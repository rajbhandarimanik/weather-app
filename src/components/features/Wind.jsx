        ...
        >
          ...
          <defs>
            <mask id="mask" x="0" y="0" width="100" height="100">
              {/* White area will be visible, black will be masked */}
              <rect width="100" height="100" fill="white" />
              <circle cx="50" cy="50" r="24" fill="black" />{' '}
              {/* Mask the intersection */}
            </mask>
          </defs>
          <circle
            cx="50"
            cy="50"
            r="46"
            stroke="rgba(229, 231, 235, 0.6)" // Adjusted color and opacity"
            strokeOpacity="0.24"
            strokeWidth="8"
            strokeDasharray="1 1"
          />
